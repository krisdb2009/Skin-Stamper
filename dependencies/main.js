var MSP = (function (global, undefined) {
	...
	var render = function () {
		...
		camera.position.z = -Math.sin(rad/(cw/2)+75+(Math.PI/0.9));
		camera.position.y = (mouseY/(ch/2))*1.5-0.3;
		camera.position.setLength(-80);
	...
	runBoxLabel.textContent = "Classic walk";
